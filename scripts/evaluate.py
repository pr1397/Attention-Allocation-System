...
def evaluate():
    ...
    for name, env, norm in tasks:
        ...
        # reward_baseline = run_episode(env, llm_agent)
        ...
        # score_baseline = min(1.0, reward_baseline / norm)
        ...
        # print(f"{name}: reward_baseline={reward_baseline:.2f}, score_baseline={score_baseline:.2f}")
